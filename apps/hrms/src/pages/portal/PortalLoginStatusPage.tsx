...
export function PortalLoginStatusPage() {
  ...
  const onlineWindow = summary?.onlineWindowMinutes ?? 30
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-text-secondary">
            Employees with portal accounts. Online = portal login within the
            last {onlineWindow} minutes.
          </p>
        </div>
      </div>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Last portal login (PKT)</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {loadingRows
